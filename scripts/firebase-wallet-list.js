/**
 * Script to fetch wallet names from GitHub repository and update WALLETS.md and specialIcons.ts
...
const GITHUB_API_URL = "https://api.github.com/repos/devopstovchain/crypto-images-backend/contents/public/images/wallet";
const GITHUB_RAW_URL = "https://github.com/devopstovchain/crypto-images-backend/tree/main/public/images/wallet";
...
// Main execution
log("Starting GitHub wallet list script...");
try {
